 ...
 * Generated: 2026-07-21T18:14:33.501Z
 */

/**
 * hive theme — built by `npx astryx theme build`
...
export const hiveTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #0f0b1a)",
    "--color-background-body": "light-dark(#f6f4f9, #08080b)",
    "--color-background-card": "light-dark(#ffffff, #0f0b1a)",
    "--color-background-popover": "light-dark(#ffffff, #1b1230)",
    "--color-background-muted": "light-dark(rgba(9, 5, 19, 0.05), rgba(8, 8, 11, 0.50))",
    "--color-accent": "light-dark(#6530a4, #7c3aed)",
    "--color-accent-muted": "light-dark(rgba(101, 48, 164, 0.12), rgba(124, 58, 237, 0.15))",
    ...
    "--color-text-primary": "light-dark(#211b29, #e5e7eb)",
    "--color-text-secondary": "light-dark(#645c6f, #9c94ab)",
    "--color-text-disabled": "light-dark(#b6a4cd, #706879)",
    "--color-text-accent": "light-dark(#6530a4, #a78bfa)",
    ...
    "--color-success": "light-dark(#0d8626, #4ade80)",
    "--color-error": "light-dark(#d31130, #fb7185)",
    "--color-warning": "light-dark(#c58600, #fbbf24)",
    "--color-success-muted": "light-dark(rgba(13, 134, 38, 0.12), rgba(74, 222, 128, 0.15))",
    "--color-error-muted": "light-dark(rgba(211, 17, 48, 0.12), rgba(251, 113, 133, 0.15))",
    "--color-warning-muted": "light-dark(rgba(197, 134, 0, 0.12), rgba(251, 191, 36, 0.15))",
    "--color-border": "light-dark(#d9d3e1, #2a203b)",
    "--color-border-emphasized": "light-dark(#b6a4cd, #4b3274)",
    ...
    "--color-background-inverted": "light-dark(#130f18, #f7f5fb)"
  },
